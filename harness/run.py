...
def main():
    ...
    cold = classify_statement(stmt, cold_mem, client.ledgers, business=client.business, materiality=200_000)
    ...
    for k, mth in enumerate(["2026-05", "2026-06", "2026-07", "2026-04", "2026-03"]):
        ...
        cal_res = classify_statement(rows_to_stmt(cal_rows), warm_mem, client.ledgers,
                                     business=client.business, materiality=200_000)
    ...
    warm = classify_statement(stmt, warm_mem, client.ledgers,
                              business=client.business, calibration=calibration, materiality=200_000)
